...
{
    public static class Prop_Alert_From_GPS_2_Container
    {
        ...
        [FunctionName("Prop_Alert_From_GPS_2_Container")]
            ...
            ILogger log)
        {
            ...
            foreach (EventData eventData in events)
            {
                ...
                var cloudEventsDataSchema = "dtmi:com:rg_az220:gps_device;1";
                ...
                try
                {
                    try
                    {
                        ...
                        if (client != null)
                        {
                            ...
                            string parentId = await AdtUtilities.FindParentAsync(client, twinId, "con_gps", log);
                            ...
                            if (parentId != null)
                            {
                                ...
                                patch.AppendAdd("/is_arrival", Convert.ToBoolean(convertedPatch.PatchItems.First(x => x.path == "/is_arrival").value));
